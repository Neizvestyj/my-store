...
const del = (idDel, color, size) => {
    store.del({ idDel, color, size })
};
//Покупка товра 
const buy = () => {
    store.buy();
            ...
            <div class="cart-form  center wrap">
                <div class="block-cart wrap center">
                    ...
                    <div v-for="card in cart" :key="card.id" class="block-cart-mini1">
                        ...
                        <div>
                            <button @click="del(card.id, card.color, card.size)" class="block-header__x"><svg
                                    class="input-svg" width="25" height="25" viewBox="0 0 18 18"
